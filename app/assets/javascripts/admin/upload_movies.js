...
(function ($) {
  ...
  movieTrailerSubmitButton = function() {
  ...
  bindClickEventOnMovieTrailerSubmitButton = function() {
    console.log('>>>>> invoked bindClickEventOnMovieTrailerSubmitButton >>>>>');

    movieTrailerSubmitButton().off('click').on('click', function() { // The button class passed into multipart_uploader_form (see "Getting Started")
...
ready = function() {
  ...
  if (movieTrailerSubmitButton().length) {
    bindClickEventOnMovieTrailerSubmitButton();
  }
};
